...
public class EventCommentFormActivity extends AbstractOpenScheduleActivity {
	...
	private static final String TAG = EventCommentFormActivity.class.getSimpleName();
	...
	private void createComment() {
		...
		Object[] params = new Object[] { selectedEvent, comment };
		new AddEventCommentTask().execute( params );
	}

	private class AddEventCommentTask extends AsyncTask<Object[], Void, Void> {
		...
		protected Void doInBackground( Object[]... params ) {
			try {
				getApplicationContext().getOpenScheduleApi().eventOperations().addEventComment( (String) params[ 0 ][ 0 ], (Comment) params[ 0 ][ 1 ] );
			} catch( Exception e ) {
